            ...
            paint: function ($element,layout ) {                        
                ...
                function (reply) {          
                    try {  
                        ...
                        $style.text(`
                        .qv-object-insightdata-pandl-v4 .inda_pandl_first_row_` + id + ` td {
                            `+ layout.qDef.firstRowStyle + `
                        }
                        ...
                        layout.qHyperCube.qPivotDataPages[0].qData.forEach(function(qDataRow,rowIndex,qData){                        
                            ...
                            if(!(reportingClassHasSelections && rpType == 'Sum')) {                    
                                ...
                                if(rowIndex == 0){
                                    $bodyrow.addClass('inda_pandl_first_row_' + id)
                                } else if (rpType == 'Base') {
                                        ...
                                        if(!columnsToHide.includes(columnIndex)) {
                                            ...
                                            if(measure.percentageCalcOption == 'divide') {                                    
                                                ...
                                                if(qData[0][columnIndex].qNum !== 0) {
                                                    value = qDataColumn.qNum / qData[0][columnIndex].qNum
                                                } else {
                                                    value = undefined;
                                                }                                        
